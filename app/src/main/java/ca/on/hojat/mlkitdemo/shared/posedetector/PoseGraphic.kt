...
internal constructor(
    ...
    override fun draw(canvas: Canvas) {
        ...
        for (i in poseClassification.indices) {
            ...
            canvas.drawText(
                poseClassification[i], classificationX, classificationY, classificationTextPaint
            )
        }
    ...
    private fun drawLine(
        canvas: Canvas, startLandmark: PoseLandmark?, endLandmark: PoseLandmark?, paint: Paint
    ) {
